    ...
    public partial class Form1 : Form
    {
        ...
        private void pullDataFromServer(int key)
        {
            ...
            try
            {
                ...
                string url = @"http://dev.racetimingsolutions.com/rfid-gun/get-chip-times?datepollfrom=" + datePollFrom[key].ToString("yyyy-MM-dd HH:mm:ss.000") + "&device=" + deviceName
                    [key];
                ...
                numOfTags.Invoke((MethodInvoker)(() => numOfTags.Text = responseList.Count.ToString()));
            }
            catch
            {
